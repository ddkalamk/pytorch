    ...
    for(auto mb = start; mb < end; mb++) {
      ...
      for(auto s = select_off_start; s < select_off_end; s++) {
        ...
        for (v = 0; v < ddim - 31; v += 32) {
          ...
          std::memcpy((void*)&tmp_values[16], (void*)&grad_block[v + 16], 8 * sizeof(float));
          std::memcpy((void*)&tmp_values[24], (void*)&grad_block[v + 24], 8 * sizeof(float));
          std::memcpy((void*)&gradout_block[v + 0], (void*)&tmp_values[0], 8 * sizeof(float));
          std::memcpy((void*)&gradout_block[v + 8], (void*)&tmp_values[8], 8 * sizeof(float));
          std::memcpy((void*)&gradout_block[v + 16], (void*)&tmp_values[16], 8 * sizeof(float));
          std::memcpy((void*)&gradout_block[v + 24], (void*)&tmp_values[24], 8 * sizeof(float));
        }
        if (n > 0) {
