  ...
  switch (scalarType) {
    ...
    case at::kBFloat16:
      *(at::BFloat16*)data = at::convert<at::BFloat16, double>(THPUtils_unpackDouble(obj));
      break;
    case at::kBFloat8:
      *(at::BFloat8*)data = at::convert<at::BFloat8, double>(THPUtils_unpackDouble(obj));
      break;
...
inline PyObject* load_scalar(void* data, at::ScalarType scalarType) {
  switch (scalarType) {
    ...
    case at::kBFloat8: return PyFloat_FromDouble(at::convert<double, at::BFloat8>(*(at::BFloat8*)data));
    default: throw std::runtime_error("invalid type");
  }
}
